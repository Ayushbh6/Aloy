...
swiftc -swift-version 5 mac/Aloy.swift mac/OrbView.swift mac/InteractionState.swift mac/Playground.swift mac/Canvas.swift mac/CompanionBubble.swift mac/ComputerActionApproval.swift mac/ScreenCapture.swift -framework AppKit -framework ApplicationServices -framework AVFoundation -framework CoreGraphics -framework ScreenCaptureKit -framework SwiftUI \
